...
* @module csg/fillkey
* @license
* Copyright (c) Marylyn Ritchie 2019
*
* This file is code for FillKey
*
...
$.widget('csg.fillkey',{
	...
	* @property {array} options.keyInfo Array of objects containing name and color properties
	*/
	options: {
  ...
  */
	_create: function() {
		...
		this.canvasID = 'csg-fillkey-'+this.widgetID;
	...
	/**
    * Draw key with shaded box to left, followed by text
    * @param {array} info Objects with name and color
  ...
  */
	_drawKey: function(info){
		...
		bar.append("rect")
			...
			.attr("fill", function(d){return d.fillType;});
  ...
  */
      ...
      'keyInfo': function () {
      	...
      	self.canvas.selectAll(".fillColorBars")
      		.remove();
      	self.options[key] = value;
